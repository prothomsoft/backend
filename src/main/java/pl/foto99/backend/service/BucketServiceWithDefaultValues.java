...
public class BucketServiceWithDefaultValues {
    ...
    final String DEFAULT_BUCKET_NAME = "javabucketdomel100";

    public void listBuckets(Optional<AwsCredentialsProvider> provider) {
        S3Client client = getClient(provider);
    ...
    public void uploadFileToDefaultBucket(InputStream resourceAsStream,
        ...
        S3Client s3Client = getClient(empty);
    ...
    private S3Client getClient(Optional<AwsCredentialsProvider> provider) {
